...
//    /**
//     * 当向客户端完成一次写操作时，触发此事件。可以通过此事件，检查IO是否现在很忙
//     * 
//     * @param writeSize 本次写入字节数
//     * @return 
//     */
//    virtual bool onWriteEvent(ssize_t writeSize){
//        return false;
//    }
...
//    
//    /**
//     * 当向客户端完成响应头信息的写入时触发此事件
//     * @return 
//     */
//    virtual bool onWriteHeadersCompletionEvent(){
//        return false;
//    }    
