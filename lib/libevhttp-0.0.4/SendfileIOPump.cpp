...
SendfileIOPump::SendfileIOPump(FD recefd, FD sendfd, unsigned int speed, size_t maxSendSize):
   recefd(recefd), sendfd(sendfd), speed((unsigned int)(speed*1.3)), maxSendSize(maxSendSize), sendedBytes(0), eagainCount(0),
